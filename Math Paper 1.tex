...
\begin{figure}[H]
	\begin{subfigure}[b]{0.5\textwidth}
		...
		\caption {Pixel representation of a boundary formed by walls.}\label{PixelBoundary}
	\end{subfigure}
	\begin{subfigure}[b]{0.5\textwidth}
		\centering
		...
		\caption {Corresponding lattice graph of the wall configuration in~\ref{PixelBoundary}}\label{BoundaryLattice}
	\end{subfigure}
